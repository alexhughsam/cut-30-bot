...
| `history.md` | Per-video log: the single change tested, what it did to the metric, the single change to test next, and the running read of the recurring weakness | `/script` (the bet) and `/autopsy` (the result + next change) |
